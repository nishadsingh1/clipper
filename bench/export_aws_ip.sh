...
echo "No clipper_ip supplied. Detected that this script is being run on an AWS instance. Setting CLIPPER_IP to the current host's IP: $aws_ip"
export CLIPPER_IP=$aws_ip
